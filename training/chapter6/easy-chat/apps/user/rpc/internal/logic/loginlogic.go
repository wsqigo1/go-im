...
import (
	...
	"github.com/wsqigo/easy-chat/pkg/encrypt"
...
var (
	...
	ErrUserPwdError     = xerr.New(xerr.REQUEST_PARAM_ERROR, "密码不正确")
)
...
func (l *LoginLogic) Login(in *user.LoginReq) (*user.LoginResp, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrapf(xerr.NewDBErr(),
			"find user by phone err %v, req %v", err, in.Phone)
	}
	...
	if err != nil {
		return nil, errors.Wrapf(xerr.NewDBErr(),
			"ctxdata get jwt token err %v", err)
	}
